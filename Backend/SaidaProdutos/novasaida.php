...
if ($id_Lote) {
    ...
    $stmtProdutos = $mysqli->prepare("INSERT INTO saida_produtos (imagem, id_Usuario, cod_Produto, nome_Produto, preco_Custo, id_Local, nome_Local, qtd_Saida, grupo, sub_Grupo, observacao, id_Lote) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
