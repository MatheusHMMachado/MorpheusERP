...
--
-- Host: 127.0.0.1    Database: projeto_gestao
-- ------------------------------------------------------
...
CREATE TABLE `entrada_produtos` (
  ...
  `grupo` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sub_Grupo` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `entrada_produtos` VALUES (1,11,'Atacadão Condimentos',364,'Abacaxi Perola GG',20,15.99,1,NULL,NULL),(2,9,'Sorriso Folhagem',364,'Abacaxi Perola GG',500,19.99,1,NULL,NULL),(3,6,'Perboni LTDA',2,'Morango',100,4.99,2,NULL,NULL),(4,10,'Marcelo Pequi',364,'Abacaxi Perola GG',700,10.99,2,NULL,NULL),(5,12,'Ione Verduras',366,'Abacaxi Perola',1000,7.33,2,NULL,NULL),(6,5,'Emporio Max LTDA',2,'Morango',852,584,3,NULL,NULL),(7,5,'Emporio Max LTDA',364,'Abacaxi Perola GG',751,7414,3,NULL,NULL),(8,5,'Emporio Max LTDA',366,'Abacaxi Perola',10,100,4,'Frutas',NULL),(9,6,'Perboni LTDA',2,'Morango',10,520,5,'Frutas',NULL),(10,5,'Emporio Max LTDA',364,'Abacaxi Perola GG',210,1,6,'Frutas','Frutas'),(11,10,'Marcelo Pequi',2,'Morango',12,12,7,'Frutas',NULL),(12,10,'Marcelo Pequi',2,'Morango',123,221,8,'Frutas',NULL),(13,8,'Ceasa Goiania',2,'Morango',410,2,9,'Frutas',NULL),(14,10,'Marcelo Pequi',2,'Morango',10,50,10,'Frutas',NULL),(15,11,'Atacadão Condimentos',366,'Abacaxi Perola',60,10,10,'Frutas',NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Update_Estoque_Entrada` AFTER INSERT ON `entrada_produtos` FOR EACH ROW BEGIN
	-- Verifica se o produto já existe no estoque
    IF EXISTS (SELECT * FROM estoque WHERE cod_Produto = NEW.cod_Produto) THEN
        -- Se o produto existe, atualiza a quantidade adicionando com a nova entrada
        UPDATE estoque
...
INSERT INTO `estoque` VALUES (1,364,1641,10,5),(2,2,1073,14,4),(3,366,1050,15,NULL);
...
INSERT INTO `lote_entrada` VALUES (1,3033,'Vitor','2024-11-10 02:46:45',NULL),(2,3033,'Vitor','2024-11-10 02:59:41',15522.00),(3,3033,'Vitor','2024-11-11 20:32:25',6065482.00),(4,3033,'Vitor',NULL,1000.00),(5,3033,'Vitor',NULL,5200.00),(6,3033,'Vitor',NULL,210.00),(7,3033,'Vitor',NULL,144.00),(8,3033,'Vitor',NULL,27183.00),(9,3033,'Vitor','2025-05-25 01:57:53',820.00),(10,3033,'Vitor','2025-05-25 11:52:52',1100.00);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Get_Date_Entrada` BEFORE INSERT ON `lote_entrada` FOR EACH ROW BEGIN
...
--
-- Table structure for table `lote_saida`
--

DROP TABLE IF EXISTS `lote_saida`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `lote_saida`
--

LOCK TABLES `lote_saida` WRITE;
/*!40000 ALTER TABLE `lote_saida` DISABLE KEYS */;
INSERT INTO `lote_saida` VALUES (1,3033,'Vitor','2025-05-24 21:20:28',399.50),(2,3033,'Vitor','2025-05-24 21:22:10',399.50),(3,3033,'Vitor','2025-05-24 21:25:25',399.50),(4,3033,'Vitor','2025-05-24 21:31:03',399.50),(5,3033,'Vitor','2025-05-24 21:35:36',79.90),(6,3033,'Vitor','2025-05-24 21:37:12',109.90),(7,3033,'Vitor','2025-05-24 21:38:46',109.90),(8,3033,'Vitor','2025-05-24 21:44:12',109.90),(9,3033,'Vitor','2025-05-24 21:44:32',95.88),(10,3033,'Vitor','2025-05-24 21:44:47',95.88),(11,3033,'Vitor','2025-05-24 21:48:37',95.88),(12,3033,'Vitor','2025-05-24 21:48:52',1054.68),(13,3033,'Vitor','2025-05-25 11:46:01',549.50),(14,3033,'Vitor','2025-05-25 11:49:34',849.20);
/*!40000 ALTER TABLE `lote_saida` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Get_Date_Saida` BEFORE INSERT ON `lote_saida` FOR EACH ROW BEGIN
	-- Atribui a data e hora atuais à coluna `data_saida` antes da inserção
...
INSERT INTO `produto` VALUES (2,'imagens/672b2af603291_1000097238.jpg',0,'Morango','Unidade',0,7.99,'Frutas',NULL,'Frutas do freezer '),(364,'imagens/672b966792185_1000170846.jpg',0,'Abacaxi Perola GG','Quilo',0,10.99,'Frutas','Frutas',''),(366,'imagens/672b1d3eb9ca8_Imagem do WhatsApp de 2024-11-06 à(s) 03.45.26_88b602e3.jpg',0,'Abacaxi Perola','Unidade',0,4.99,'Frutas',NULL,'');
...
CREATE TABLE `saida_produtos` (
  ...
  `observacao` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `id_Lote` int NOT NULL,
  ...
  CONSTRAINT `id_Lote_fksp` FOREIGN KEY (`id_Lote`) REFERENCES `lote_saida` (`id_Lote`),
...
INSERT INTO `saida_produtos` VALUES (1,_binary 'imagens/img_683268e5d6fac5.77073176.jpg',3033,2,'Morango',7.99,18,'Pablo',12,'0',NULL,'dfb',11,NULL,NULL),(2,_binary 'imagens/img_683268f4b3fa42.31181806.jpg',3033,2,'Morango',7.99,18,'Pablo',132,'0',NULL,'21e4',12,NULL,NULL),(3,_binary 'imagens/img_68332d29147359.87555519.jpg',3033,364,'Abacaxi Perola GG',10.99,18,'Pablo',50,'0','Frutas','dhbeb',13,NULL,NULL),(4,_binary 'imagens/img_68332dfe528647.97499106.jpg',3033,2,'Morango',7.99,18,'Pablo',10,'0',NULL,'',14,NULL,NULL),(5,_binary 'imagens/img_68332dfe54f1f3.30150059.jpg',3033,364,'Abacaxi Perola GG',10.99,18,'Pablo',70,'0','Frutas','sdffb',14,NULL,NULL);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `Update_Estoque_Saida` AFTER INSERT ON `saida_produtos` FOR EACH ROW BEGIN
	-- Verifica se o produto já existe no estoque
    IF EXISTS (SELECT * FROM estoque WHERE cod_Produto = NEW.cod_Produto) THEN
        -- Se o produto existe, atualiza a quantidade adicionando com a nova saida
        UPDATE estoque
        SET qtd_Estoque = qtd_Estoque - NEW.qtd_Saida,
			id_Saida = NEW.id_Saida
        WHERE cod_Produto = NEW.cod_Produto;
    ELSE
        -- Se o produto não existe, insere um novo registro no estoque
        INSERT INTO estoque (cod_Produto, qtd_Estoque, id_Saida)
        VALUES (NEW.cod_Produto, NEW.qtd_Saida, NEW.id_Saida);
    END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
--
-- Temporary view structure for view `saidas_por_data`
--

DROP TABLE IF EXISTS `saidas_por_data`;
/*!50001 DROP VIEW IF EXISTS `saidas_por_data`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `saidas_por_data` AS SELECT 
 1 AS `id_Lote`,
 1 AS `id_Usuario`,
 1 AS `nome_Usuario`,
 1 AS `data_Saida`,
...
--
-- Dumping events for database 'projeto_gestao'
--

--
-- Dumping routines for database 'projeto_gestao'
--
...
--
-- Final view structure for view `saidas_por_data`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `saidas_por_data` AS select `lote_saida`.`id_Lote` AS `id_Lote`,`lote_saida`.`id_Usuario` AS `id_Usuario`,`lote_saida`.`nome_Usuario` AS `nome_Usuario`,`lote_saida`.`data_Saida` AS `data_Saida`,`lote_saida`.`valor_Lote` AS `valor_Lote` from `lote_saida` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-05-25 15:13:17
